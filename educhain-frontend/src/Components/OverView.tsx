import { Trophy, Zap, Book, Coins } from "lucide-react"
    ...
    <div className="min-h-screen bg-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center pt-20">
        ...
        <div className="relative w-full max-w-4xl h-64 mb-8">
          ...
          {/* Floating 3D elements around the center */}
          {/* Books */}
          ...
          <div className="absolute bottom-16 right-16">
            <div className="w-8 h-8 bg-gradient-to-r from-pink-400 to-purple-500 rounded-lg transform -rotate-12"></div>
          </div>
          <div className="absolute top-24 right-12">
            <div className="w-4 h-4 bg-yellow-400 rounded-full"></div>
          </div>
          <div className="absolute bottom-24 left-12">
            <div className="w-5 h-5 bg-gradient-to-r from-green-400 to-cyan-400 rounded transform rotate-45"></div>
          </div>
        </div>
